    ...
    return (
        <div className="flex flex-col items-center group">
            ...
            >
                ...
                />
                <video ref={videoRef} src={skin.video} loop muted playsInline preload="none" className="absolute inset-0 w-full h-full object-cover z-10 grayscale-25 group-hover:grayscale-0" />
            </div>
