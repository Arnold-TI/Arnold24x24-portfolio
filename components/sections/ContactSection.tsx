        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="px-6 md:px-12 pt-16 flex flex-col items-center grow justify-center min-h-[50vh]">
            ...
            <div className="w-full max-w-2xl bg-[#0a1324]/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 md:p-12 shadow-[0_0_40px_rgba(5,11,20,0.8)] flex flex-col items-center text-center relative overflow-hidden">
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                    ...
                    <h2 className="text-xl md:text-5xl font-black tracking-tighter uppercase drop-shadow-[0_3px_10px_rgba(0,0,0,1)] mb-4 md:mb-6" style={{ fontFamily: "'Quicksand', sans-serif", fontWeight: 700 }}>
